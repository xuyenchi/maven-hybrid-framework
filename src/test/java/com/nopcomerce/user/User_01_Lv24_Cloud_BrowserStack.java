...
public class User_01_Lv24_Cloud_BrowserStack extends BaseTest {
    WebDriver driver;
    ...
    public User_01_Lv24_Cloud_BrowserStack() {
        super();
    }

    @Parameters({"environment", "os", "osVersion", "browser", "browserVersion"})
    @BeforeClass
    public void beforeClass(String environment, String osName, String osVersion, String browserName, String browserVersion) {
        ...
        driver = getBrowserNameBrowserStack(propertiesConfig.getApplicationUrl(), osName, osVersion, browserName, browserVersion);

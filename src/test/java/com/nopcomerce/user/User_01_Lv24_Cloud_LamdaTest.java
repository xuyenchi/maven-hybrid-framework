...
public class User_01_Lv24_Cloud_LamdaTest extends BaseTest {
    WebDriver driver;
    ...
    public User_01_Lv24_Cloud_LamdaTest() {
        super();
    }
    ...
    public void beforeClass(String environment, String platform, String browserName, String browserVersion) {
        ...
        driver = getBrowserNameLamdatest(propertiesConfig.getApplicationUrl(), platform, browserName, browserVersion);
